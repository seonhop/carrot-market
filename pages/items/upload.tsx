			...
			<div className="my-5">
				...
				<div className="relative flex items-center rounded-md shadow-sm ">
					...
					<input
						...
						type="text"
						placeholder="0.00"
						className="flex w-full appearance-none items-center rounded-md  border border-gray-300 px-3 py-2 pl-7 placeholder-gray-400 shadow-sm focus:border-orange-500 focus:outline-none focus:ring-orange-500"
					/>
